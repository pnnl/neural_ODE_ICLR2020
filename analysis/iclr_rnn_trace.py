...
os.chdir('../')
from system_id_nlin import make_dataset, RNN, Building_DAE
...
def plot_trajectories(traj1, traj2, labels, figname):
    ...
    plt.text(1500, 15, "Train", fontsize=8)
    plt.text(3200, 15, "Validation", fontsize=8)
    plt.text(5600, 15, "Test", fontsize=8)
